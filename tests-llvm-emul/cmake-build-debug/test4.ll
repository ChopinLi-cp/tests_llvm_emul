...
define i32 @_Z5shiftii(i32 %c, i32 %b) #2 {
entry:
  ...
  %call1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call, i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0))
...
define internal void @_GLOBAL__sub_I_test1.cpp() section ".text.startup" {
entry:
